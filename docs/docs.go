...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.InventoryAdjustmentInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/inventories/damage": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Damage Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.InventoryOperationInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/inventories/{productVariantID}/transactions": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "model.InventoryAdjustmentInput": {
            "type": "object",
            "required": [
                "product_variant_id",
                "quantity"
